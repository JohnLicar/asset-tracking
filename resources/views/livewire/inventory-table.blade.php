 ...
 <div>
    ...
    <div class=" bg-white rounded-lg shadow-xs">
        <div class=" flex justify-between space-x-4 mb-3">
            ...
            <x-input wire:model.debounce.300ms="search" id="search" class=" right-0 w-1/3" type="search" name="search" placeholder="Search Item" :value="old('search')" />
        </div>
                    ...
                    @foreach($items as $index => $item)
                        <tr class="text-gray-700">
                            ...
                            <td class="flex  px-4 py-3 text-sm">
                                <a href="{{ route('inventory.edit', $item) }}" class="mt-2 mr-5 text-indigo-600 hover:text-indigo-900">
                                    <i class="gg-pen"></i>
