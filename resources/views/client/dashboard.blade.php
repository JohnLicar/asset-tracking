            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between p-6 bg-white border-b border-gray-200">
                    <div
                        ...
                        <h1 class="ml-5 text-xl font-bold text-white">Approve Requisition</h1>
                        <div class="flex ml-14 mt-4 text-white">
                            ...
                            <p class="text-7xl ml-14  font-black">{{ $approve }}</p>
                        </div>
                    </div>
                    <div
                        ...
                        <h1 class="ml-5 text-xl font-bold text-white">Decline Requisition</h1>
                        <div class="flex ml-14 mt-4 text-white">
                    ...
                    <div
                        ...
                        <div class="flex ml-14 mt-4 text-white">
                            ...
                            <p class="text-7xl ml-10 font-black">{{ $request }}</p>
                        </div>
                    </div>
                </div>
            </div>
