                    ...
                    <form method="POST" action="{{  route('inventory.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="unit" class="block mt-1 w-full" type="text" name="unit" :value="old('unit')"/>
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="life_span" class="block mt-1 w-full" type="text" name="life_span" :value="old('life_span')" />
                            </div>


                            <div class="col-span-full">
                                <x-label for="description" :value="__('Description')" />
                                <textarea cols="42" rows="5" id="description" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 focus-within:text-primary-600" name="description">{{ old('description') }}</textarea>
                            </div>
